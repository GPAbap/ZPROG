...
************************************************************************
REPORT zco_desbloqueo_sa00_pres MESSAGE-ID ze LINE-SIZE 255 LINE-COUNT 65.
TABLES:
...
FORM bloqueo .
  ...
  "wa_costcenterlist-lock_ind_act_secondary_costs = '.'. "si desea desbloquear el indicador de bloqueo, introduzca el valor "."
