...
************************************************************************
REPORT zfi_bloqueo_ga00_pres MESSAGE-ID ze LINE-SIZE 255 LINE-COUNT 65.
TABLES:
...
* Contabilizaciones Externas
  ...
  wrg_objnr-option = 'BT'.
  wrg_objnr-low = 'KSGA000000000000'.
  wrg_objnr-high = 'KSGA00ZZZZZZZZZZ'.
  wrg_objnr-sign = 'I'.
  APPEND wrg_objnr TO rg_objnr.

  vl_status = abap_false.
  ...
  LOOP AT it_cosp INTO DATA(wa_cosp).
    CASE sy-datum+4(2).
      ...
      WHEN '04'.
        ...
        APPEND cosp_p.
      WHEN '05'.
        PERFORM valida_ctas_provisiones USING wa_cosp-kstar
                                        CHANGING vl_status.

        IF vl_status EQ abap_false.
...
*      coss-kstar  to cosp_p-kstar,
        ...
        APPEND cosp_p.
      WHEN '05'.
        PERFORM valida_ctas_provisiones USING wa_coss-kstar
                                        CHANGING vl_status.
...
*      coss-kstar  to cosp_p-kstar,
  ...
  ENDLOOP.
ENDFORM.
FORM valida_ctas_provisiones USING p_kstar TYPE kstar
                             CHANGING p_status.
  DATA vl_status.
  vl_status = abap_false.

  IF p_kstar EQ '0601003001' OR p_kstar EQ '0601003002' OR
              p_kstar EQ '0601003003' OR p_kstar EQ '0601003004' OR
              p_kstar EQ '0601003005' OR p_kstar EQ '0601003006' OR
              p_kstar EQ '0601003007'.
...
*        perform correo3.
      ...
      ELSE.   " no tiene presupuesto, no tiene registro PT
