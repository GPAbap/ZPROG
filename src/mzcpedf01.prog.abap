...
*         quantity                = 1
    ...
    IF vg_oferta = abap_false.
      vg_final = abap_true.
      MODIFY zsdtt_001 FROM TABLE tg_p101.
...
*     AND entrega = space.
  ...
  IF sy-subrc NE 0.
    READ TABLE tg_p101 INTO sg_p101
...
*    sl_head-purch_no_c = 'PedAuto'.
  ...
  LOOP AT tg_p101 INTO sg_p101.
    ...
    sl_item-material   = sg_p101-matnr.
    sl_item-plant      = sg_p101-werks.
    sl_item-store_loc  = sg_p101-lgort.
    sl_item-target_qty = sg_p101-lfimg.
...
*   Asinga el número de posición
  ...
  IF vg_vbeln IS NOT INITIAL.
    ...
    sg_p101-vbeln = vg_vbeln.
    MODIFY tg_p101 FROM sg_p101 TRANSPORTING vbeln
