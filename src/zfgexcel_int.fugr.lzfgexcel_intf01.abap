...
FORM separated_to_intern_convert  TABLES   i_tab TYPE  ty_t_sender
  ...
  LOOP AT i_tab.
    ...
    IF i_tab <> space.
      CLEAR i_intern.
      i_intern-namesheet = p_namesheet.
      i_intern-p_rows = l_sic_tabix.
      i_intern-p_cols = l_sic_col + 1.
...
FORM line_to_cell_separat TABLES i_intern    TYPE ty_t_itab
  ...
  CLEAR i_intern.
  l_sic_int = i_fdpos.
  i_intern-namesheet = i_namesheet.
  i_intern-p_rows = i_row.
  l_string = i_line.
  i_intern-p_cols = ch_cell_col.
