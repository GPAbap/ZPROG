...
*&
*&---------------------------------------------------------------------*
REPORT zfi_rep_costos_prod_gax.
...
DATA: it_conf TYPE STANDARD TABLE OF zfi_rep_co_gax WITH HEADER LINE,
      it_cont TYPE STANDARD TABLE OF zfi_rep_co_gax WITH HEADER LINE,
      it_cons TYPE STANDARD TABLE OF zfi_rep_co_gax WITH HEADER LINE.
