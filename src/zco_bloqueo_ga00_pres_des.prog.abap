...
************************************************************************
REPORT zco_bloqueo_ga00_pres_des MESSAGE-ID ze LINE-SIZE 255 LINE-COUNT 65.
TABLES:
...
*     " Mandamos el correo
        ...
        CONCATENATE lv_porc1 '%'
          INTO lv_porc1.
        CONCATENATE 'El centro de costos'
          cosp_rt-objnr+6(10) 'ha llegado al'
          lv_porc1 'del plan.'
          INTO lv_mensaje SEPARATED BY space.
        CONCATENATE 'CECO' cosp_rt-objnr+6(10)
          '[AVISO DE LIMITE DE PRESUPUESTO]'
          INTO lv_encabezado SEPARATED BY space.
...
*    Query para sacar el correo del ceco
        ...
        CONCATENATE lv_porc2 '%'
          INTO lv_porc2.
        CONCATENATE 'El centro de costos'
          cosp_rt-objnr+6(10) 'ha llegado al'
          lv_porc2 'del plan y está próximo a bloquearse'
          INTO lv_mensaje SEPARATED BY space.
        CONCATENATE 'CECO' cosp_rt-objnr+6(10)
          '[AVISO DE LIMITE DE PRESUPUESTO]'
          INTO lv_encabezado SEPARATED BY space.
  ...
  IF sy-subrc NE 0.
    ...
    IF sy-subrc = 0.
      ...
      IF sy-subrc = 0.
        ...
        CONCATENATE 'El centro de costos'
        cosp_rt-objnr+6(10) 'ha llegado al'
        lv_porc3 'del plan y se ha bloqueado.'
        INTO lv_mensaje SEPARATED BY space.
        CONCATENATE 'CECO' cosp_rt-objnr+6(10)
        '[AVISO DE LIMITE DE PRESUPUESTO]'
        INTO lv_encabezado SEPARATED BY space.
