...
************************************************************************
REPORT zco_desbloqueo_ga00_pres MESSAGE-ID ze LINE-SIZE 255 LINE-COUNT 65.
TABLES:
...
FORM bloqueo .
  ...
  wa_costcenterlist-lock_ind_actual_primary_costs = '.'. "sap note 2460020
  "si desea desbloquear el indicador de bloqueo, introduzca el valor "."
  "wa_costcenterlist-lock_ind_act_secondary_costs = '.'. "sap note 2460020
