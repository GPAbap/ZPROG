...
START-OF-SELECTION.
  ...
  PERFORM real.
  PERFORM compara.
  SUBMIT zfi_nobloqueo_pres AND RETURN. "programa que deja de bloquear Centros de Costo que no deben bloquearse
...
* Contabilizaciones Externas
  ...
  "lista de Cuentas a eliminar(excluir) solo en 2024
  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0401007001'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0504001004'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0504025005'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0504025015'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0504025047'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0504025048'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0504025050'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0504025051'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0504025052'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0504025053'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0504025106'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0601001024'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0601001033'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0601001052'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0601001121'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0601001124'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0601001190'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0601001191'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0601001192'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.

  wrg_kstar-option = 'EQ'.
  wrg_kstar-low = '0601001386'.
  wrg_kstar-sign = 'I'.
  APPEND wrg_kstar TO rg_kstar.
...
*
  ...
  FROM cosp
*    WHERE  OBJNR eq 'KSGA00SP0141'
*    WHERE  objnr BETWEEN 'KSGA000000000000' AND 'KSGA00ZZZZZZZZZZ'
  WHERE  objnr IN @rg_objnr
*    AND    kstar NOT BETWEEN '0000401600' AND '0000401634'
  AND kstar NOT BETWEEN '0504025112' AND '0504025119'
  AND kstar NOT BETWEEN '0701000000'AND'0799999999'
  ...
  "se eliminan de la consulta si son 2024
  IF sy-datum+0(4) EQ '2024'.
    DELETE it_cosp WHERE kstar IN rg_kstar.

  ELSE.
    REFRESH rg_kstar.
    wrg_kstar-option = 'EQ'.
    wrg_kstar-low = '0701001001'.
    wrg_kstar-sign = 'I'.
    APPEND wrg_kstar TO rg_kstar.

    wrg_kstar-option = 'EQ'.
    wrg_kstar-low = '0702001001'.
    wrg_kstar-sign = 'I'.
    APPEND wrg_kstar TO rg_kstar.
...
** call transaction 'KS02' using bdc_data mode 'A'.
  ...
  "wa_costcenterlist-lock_ind_act_secondary_costs = 'X'. "se omite, solo se deja el bloqueo de costos primarios JHV 09042025
...
*      lv_pernr = lv_name1.
      ...
      " obtenemos el correo con el numero de empleado
*      SELECT SINGLE USRID_LONG
*        FROM PA0105
*        INTO LV_CORREO
*        WHERE pernr = lv_pernr.
      IF lv_correo IS INITIAL.
        lv_correo = 'asancheza@gporres.com.mx'.
      ENDIF.
      lv_mail = lv_correo.
      " si encuentra datos
      IF sy-subrc = 0.
